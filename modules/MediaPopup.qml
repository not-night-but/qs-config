...
PopupWindow {
    ...
    required property bool playerVisible
    ...
    Behavior on visible {
        NumberAnimation {
            duration: Settings.defaultDuration * 2
    ...
    Rectangle {
        ...
        property bool playerVisible: win.playerVisible

        color: Settings.background
        radius: Settings.cornerRadius
        width: root.playerVisible ? 375 : 0
        height: root.playerVisible ? 200 : 0
        ...
        ColumnLayout {
            ...
            anchors.leftMargin: root.playerVisible ? 20 : -100
            ...
            Text {
                id: backButton
                // TODO (@day): this still doesn't look perfect
